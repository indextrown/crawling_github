...
#파일 생성    'w': 쓰기모드  encoding: 인코딩속성(깨짐방지)  newline : 줄바꿈 없애기(윈도우 경우)
f = open(r"C:\Users\Index\PycharmProjects\startproject\chapter03\네이버 쇼핑\data.csv", 'w', encoding='CP949', newline='')

#csvwriter를 만들어줌 = > f(file)을 넘겨줌
