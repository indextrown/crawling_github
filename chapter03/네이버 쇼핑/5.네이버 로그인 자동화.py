...
#메일쓰기 버튼
sendmail = driver.find_element(By.CSS_SELECTOR, "a.btn_quickwrite")
sendmail.click()

#메일 수신자 입력
mailaddress = driver.find_element(By.CSS_SELECTOR, "#toInput")
mailaddress.click()
...
#메일 제목 입력
mailaddress = driver.find_element(By.CSS_SELECTOR, "#subject")
mailaddress.click()
...
#메일 내용 입력
#sendmail = driver.find_element(By.CSS_SELECTOR, "body.se2.inputarea")
#sendmail.click()